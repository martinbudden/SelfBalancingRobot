...
constexpr uint8_t REG_AUX_DEV_ID            = 0x4B;
constexpr uint8_t REG_AUX_IF_CONF           = 0x4C;
constexpr uint8_t REG_AUX_RD_ADDR           = 0x4D;
...
constexpr uint8_t REG_INT_LATCH             = 0x55;
constexpr uint8_t REG_INT1_MAP_FEAT         = 0x56;
...
constexpr uint8_t REG_GYR_SELF_TEST         = 0x6E;
constexpr uint8_t REG_NV_CONF               = 0x70;
constexpr uint8_t REG_OFFSET_0              = 0x71;
constexpr uint8_t REG_OFFSET_1              = 0x72;
constexpr uint8_t REG_OFFSET_2              = 0x73;
constexpr uint8_t REG_OFFSET_3              = 0x74;
...
IMU_BMI270::IMU_BMI270(axis_order_t axisOrder, uint8_t SDA_pin, uint8_t SCL_pin, uint8_t I2C_address, void* i2cMutex) :
    IMU_Base(axisOrder, i2cMutex),
    _bus(I2C_address, SDA_pin, SCL_pin)
{
}
#else
IMU_BMI270::IMU_BMI270(axis_order_t axisOrder, uint32_t frequency, uint8_t CS_pin) :
    IMU_Base(axisOrder),
