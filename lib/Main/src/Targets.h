...
*/
...
#if defined(TARGET_M5UNIFIED_STICKC_BALAC)
    ...
    //#define MOTOR_I2C_PINS      {.sda=0,.scl=26,.irq=0xFF}
#endif

#if defined(TARGET_M5UNIFIED_FIRE_BALA2)
    //#define USE_RECEIVER_TASK_TIME_BASED_SCHEDULING
    #define IMU_AXIS_ORDER      IMU_Base::XPOS_YPOS_ZPOS
    #define USE_IMU_MPU6886
    #define IMU_I2C_PINS        {.sda=21,.scl=22,.irq=0xFF}

    #define MOTORS_BALA_2
    #define MOTORS_HAVE_ENCODERS
    #define MOTOR_SDA_PIN       21
    #define MOTOR_SCL_PIN       22
    //#define MOTOR_I2C_PINS      {.sda=21,.scl=22,.irq=0xFF}
    #define I2C_MUTEX_REQUIRED
#endif

#if defined(TARGET_M5UNIFIED_GREY_4ENCODERMOTOR)
...
#if defined(TARGET_M5UNIFIED_FIRE_GOPLUS2)
    #define IMU_AXIS_ORDER      IMU_Base::YNEG_XPOS_ZPOS
    #define USE_IMU_MPU6886
    //#define IMU_I2C_SDA_PIN     21
    //#define IMU_I2C_SCL_PIN     22
...
#if defined(TARGET_M5UNIFIED_FIRE_ODRIVE_CAN)
    #define IMU_AXIS_ORDER      IMU_Base::XPOS_YPOS_ZPOS
    #define USE_IMU_BMI270
    #define IMU_SPI_PINS        {.cs=0,.sck=0,.cipo=0,.copi=0,.irq=0xFF}
    //#define IMU_I2C_SDA_PIN     21
    //#define IMU_I2C_SCL_PIN     22
    #define IMU_I2C_PINS        {.sda=21,.scl=22,.irq=0xFF}
...
#if defined(TARGET_M5UNIFIED_FIRE_ODRIVE_TWAI)
    #define IMU_AXIS_ORDER      IMU_Base::XPOS_YPOS_ZPOS
    #define USE_IMU_MPU6886
    //#define USE_IMU_M5_UNIFIED
    //#define IMU_I2C_SDA_PIN     21
...
#if defined(TARGET_M5UNIFIED_ATOMS3R_MOTION_BASE)
    #define IMU_AXIS_ORDER      IMU_Base::XPOS_YPOS_ZPOS
    #define USE_IMU_BMI270
    ...
    //#define MOTOR_I2C_PINS      {.sda=38,.scl=39,.irq=0xFF}
#endif
    ...
    #define IMU_I2C_PINS        {.sda=32,.scl=33,.irq=0xFF}
