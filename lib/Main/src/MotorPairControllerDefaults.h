...
constexpr PIDF::PIDF_t speedPID_DefaultParallel                 { 0.030F,   0.00F,  0.0F,    0.00F };
...
constexpr MotorPairController::control_mode_e controlModeDefault = MotorPairController::CONTROL_MODE_SERIAL_PIDS;
