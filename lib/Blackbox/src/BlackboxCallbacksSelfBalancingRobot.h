...
public:
    ...
    virtual void loadMainStateFromFlightController(blackboxMainState_t& blackboxCurrent, float blackboxHighResolutionScale) override;
    virtual void loadMainStateFromFlightController(blackboxMainState_t& blackboxCurrent, float blackboxHighResolutionScale, const xyz_t& gyroRPS, const xyz_t& gyroRPS_unfiltered, const xyz_t& acc) override;
